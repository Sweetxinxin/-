...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        #s1
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=1, egressspec=3, dir=0)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=1, egressspec=4, dir=0)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=2, egressspec=3, dir=0)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=2, egressspec=4, dir=0)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=3, egressspec=1, dir=1)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=3, egressspec=2, dir=1)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=4, egressspec=1, dir=1)
        checkports(p4info_helper,swIngress=s1, swEgress=s1,ingressport=4, egressspec=2, dir=1)
        ...
        writeForwardRules(p4info_helper, swIngress=s2, swEgress=s3,dstEthernetAddr="08:00:00:00:01:00", dstIPAddr=["10.0.2.2", 32], dstPort=1)
